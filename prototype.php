      ...
      <div id="page-content-wrapper">
        <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4 border-bottom">
          ...
          <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
            data-bs-target="#navbarSupportedContent" aria-controls="navbarSupporteContent" aria-expanded="false"
            ...
            <ul class="navbar-nav  ms-auto mb-2 mb-lg-0">
              ...
              <div class="row text-center me-3">
                <div class="col-md-3 px-0">
                  <a href="locker.php?landing=adash-onlineapp" class="btn btn-sm <?php $locker->lockerButtonClr(); ?>">
                    <?php $locker->lockerButton(); ?>
                  </a>
                </div>
                <div class="col-md-9">
              ...
              <li class="nav-item dropdown ">
                ...
                <a href="#" class="nav-link dropdown-toggle second-text fw-bold username" id="navbarDropdown"
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                  ...
                  <li><a href='logout.php' class='dropdown-item'><i class="fa-solid fa-person-walking-arrow-right"></i>
                      Logout</a></li>
