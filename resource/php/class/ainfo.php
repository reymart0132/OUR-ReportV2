        ...
        echo "<div class='col-md-10'>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        echo "</ul><hr>";
                        echo "Special Instructions:<h5><b class='text-danger'>$inst</b></h5><hr>";
                            $user = new user();
                            if($user->data()->groups == 2){
                                if(isset($_POST['saveinst'])){
                                    kcej_vfnotes();
                                }
                                echo "<form method='post'>
                                        <label for='vfnotes' class='form-label'>Verifier Notes:</label>
                                        <textarea class='form-control form-control-sm txt-inst' name='vfnotes' id='vfnotes' rows=3'>$vfNotes</textarea>
                                        <input type='hidden' name='type' value='reg'>
                                        <input type='hidden' name='transID' value='$transID'>
                                        <button type='submit 'class='btn btn-sm btn-primary my-3' name='saveinst'>Save Notes</button>
                                    </form>";
                            }else{
                                echo "Verifier Notes:<h5><b class='text-danger'>$vfNotes</b></h5>";
                            }
                        echo "</td>
                        <td class='py-4 px-5' width='40%'>
                    ...
                    echo "<tr>
                            ...
                            if (empty($result[0]['facebook'])) {
                                ...
                                echo  "<a href='#' class='btn btn-sm btn-danger m-1 remove-request' data-bs-toggle='modal' data-bs-target='#confirmationModal' data-transaction-id='$transID' data-toggle='tooltip' data-placement='top' title='Remove Request'><i class='fa-solid      fa-trash'></i>Remove Request</a></td></tr>";
                        }
                    echo "</table></div>";
    }
