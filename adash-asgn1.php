              ...
              <ul class="navbar-nav  ms-auto mb-2 mb-lg-0">
                ...
                <div class="row text-center me-3">
                  <div class="col-md-3 px-0">
                    <a href="locker.php?landing=adash-asgn1" class="btn btn-sm <?php $locker->lockerButtonClr(); ?>"><?php $locker->lockerButton(); ?></a>
                  </div>
                  <div class="col-md-9">
          ...
          <div class="container-fluid p-5">
            <div class="row">
              ...
              <div class="col-md-5 p-5 content ">
               ...
               <canvas id="myChart" height="250px" width="550px"></canvas>
.              </div>
            </div>
          </div>
        </div>
