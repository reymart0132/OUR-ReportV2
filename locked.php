        ...
        <section>
            <div class = "row">
                ...
                <div class=" row inner-faq p-3 mb-3 d-flex justify-content-center">
                    <div class="col-md-8 px-2 m-2">
                        <div class="card card-closed text-center">
                            <!-- <div class="card-header">
                                Featured
                            </div> -->
                            <div class="card-body">
                                <h1 class="card-title big-txt-faq mt-5">OUR Document Request Form is currently closed.</h1>
                                <p class="card-text sm-txt-faq mb-5">Request Form is open during Monday to Saturday, 8:00 a.m. to 5:00 p.m., Philippine Standard Time (GMT+8)</p>
                            </div>
